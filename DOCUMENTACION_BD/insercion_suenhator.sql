...
INSERT INTO sala (nombre, capacidad, estado) VALUES
('Sala Playa Onírica', 3, 'disponible'),
('Sala Mansión Zombi', 3, 'disponible'),
('Sala Bosque de Nubes', 2, 'ocupada'),
('Sala Oficina Dramática', 2, 'mantenimiento');
...
INSERT INTO pago (id_compra, fecha_pago, importe, metodo, estado) VALUES
(1, '2026-03-10', 39.99, 'tarjeta', 'completado'),
(2, '2026-03-12', 49.99, 'bizum', 'completado'),
(3, '2026-03-16', 55.00, 'transferencia', 'pendiente'),
(4, '2026-03-18', 99.99, 'efectivo', 'reembolsado'),
(5, '2026-03-20', 99.99, 'tarjeta', 'completado');

INSERT INTO reserva (id_cliente, id_sala, id_pack, id_supervisor, fecha, hora, duracion, estado, es_confirmado) VALUES
(1, 1, 1, 1, '2026-04-01', '18:00:00', 40, 'confirmada', 1),
(2, 2, 2, 2, '2026-04-02', '20:00:00', 60, 'confirmada', 1),
(3, 3, 3, 1, '2026-04-05', '17:30:00', 90, 'pendiente', 0),
(4, 4, 4, 3, '2026-04-08', '21:00:00', 90, 'cancelada', 0),
(5, 3, 4, 2, '2026-04-10', '19:00:00', 90, 'completada', 1);
...
(2, 'intro_pack_aventura.mp4', 'Intro especial para Pack Aventura con nombres de los participantes.', '2026-03-27', '2026-03-30', 'en_proceso'),
